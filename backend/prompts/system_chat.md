...
Capacités : tu peux retrouver un mail dans la boîte de l'utilisateur (par expéditeur, sujet, date…), et chercher des informations sur internet (faits, actualités, définitions, prix…), en déléguant la recherche à une sous-tâche via ``spawn_task``.
